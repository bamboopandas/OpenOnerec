...
# bash eval_script_false.sh ../checkpoints/OneRec-8B-pro results_8B false ../raw_data/onerec_data/benchmark_data_1000 1
# bash eval_script_false.sh ../checkpoints/OneRec-8B results_8B false ../raw_data/onerec_data/benchmark_data_1000 2
