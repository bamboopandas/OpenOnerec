...
# Example: bash eval_script_compressed.sh ../checkpoints/OneRec-1.7B results_compressed_1.7B true ../raw_data/onerec_data/benchmark_data_1000
...
ARGS="--generator_type vllm --summarizer_model_path $SUMMARIZER_MODEL --sample_size 3"
# ARGS="--generator_type compressed_cot --summarizer_model_path $SUMMARIZER_MODEL --sample_size 3"
