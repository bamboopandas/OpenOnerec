#!/bin/bash
# bash eval_script_rag4.sh ../checkpoints/OneRec-1.7B results_1.7B true ../raw_data/onerec_data/benchmark_data_1000 0


# Set common variables
MODEL_PATH=$1
VERSION="${VERSION:-v1.0_1000_thinktrue_ours_v1_0.0}"
ENABLE_THINKING=$3
CUSTOM_DATA_DIR=$4
GPU_ID="${5:-1}"
