...
# bash eval_script_false.sh ../checkpoints/OneRec-8B results_8B true ../raw_data/onerec_data/benchmark_data_1000 0



# Set common variables
MODEL_PATH=$1
VERSION="${VERSION:-v1.0_1000_thinktrue_tryspeed}"
ENABLE_THINKING=$3
CUSTOM_DATA_DIR=$4
GPU_ID="${5:-0}"
