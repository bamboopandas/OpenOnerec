...
# Add parent directory to path to allow imports from benchmark
sys.path.append(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))

from benchmark import Benchmark
from benchmark.console import *
from benchmark.ads_generator import ADSHuggingFaceGenerator
from utils.compressed_cot_generator import CompressedCoTGenerator  # Import the new generator
...
def main():
    ...
    # We force usage of CompressedCoTGenerator for this script
    console.print(f"Initializing Compressed CoT Generator (Ray+vLLM)...", style=warning_style)
    
    generator = CompressedCoTGenerator(
    ...
    # 3. Generate text
    # Note: We pass standard parameters. CompressedCoTGenerator.generate() handles the 3-stage logic internally.
    benchmark.run(
        generator=generator,
        ...
        # Additional parameters can be passed if needed by the generator
        max_new_thinking_tokens=prompt_config.max_new_thinking_tokens,
    )
