#!/bin/bash
# bash eval_script_rag4_run_5090l.sh ../checkpoints/OneRec-1.7B results_1.7B true ../raw_data/onerec_data/benchmark_data_1000 0


# Set common variables
MODEL_PATH=$1
VERSION="${VERSION:-v1.0_1000_try5090l_wenben_b}"
