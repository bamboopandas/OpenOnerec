#!/bin/bash
# cd benchmarks && CUDA_VISIBLE_DEVICES=7 bash eval_script_rag.sh ../checkpoints/OneRec-1.7B results_1.7B false ../raw_data/onerec_data/benchmark_data_rag
# Set common variables
MODEL_PATH=$1
VERSION="${VERSION:-v5.0_false_RAG_v2}"
ENABLE_THINKING=$3
CUSTOM_DATA_DIR=$4
