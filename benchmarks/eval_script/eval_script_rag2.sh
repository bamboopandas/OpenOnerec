# true
# bash eval_script_rag2.sh ../checkpoints/OneRec-1.7B results_1.7B false ../raw_data/onerec_data/benchmark_data_rag_id

#!/bin/bash

# Set common variables
MODEL_PATH=$1
VERSION="${VERSION:-v9.0_false_RAG_id_v3}"
ENABLE_THINKING=$3
CUSTOM_DATA_DIR=$4
...
if [ -n "$GPU_IDS" ]; then
    ...
    echo "Using specific GPUs: $GPU_IDS_ARGS --force_disable_optimizations"
fi
...
#     --num_gpus 1 \
#     $GPU_IDS_ARGS --force_disable_optimizations \
