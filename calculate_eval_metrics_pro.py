...
# Modified BASE_DIR for OneRec-8B-pro
BASE_DIR = "benchmarks/results/v1.0_1000_thinktrue_tryspeed/results_results_8B/OneRec-8B-pro/OneRec-8B-pro"
# Output file in the same directory as eval_results.json for OneRec-8B-pro
OUTPUT_FILE = "benchmarks/results/v1.0_1000_thinktrue_tryspeed/results_results_8B/OneRec-8B-pro/eval_results_all.json"
...
def main():
    ...
    for task in TASKS:
        ...
        if valid_samples > 0:
            ...
            all_results["OneRec-8B-pro"][task] = {
                "test": {
             ...
             all_results["OneRec-8B-pro"][task] = {"test": {"total_samples": 0}}
